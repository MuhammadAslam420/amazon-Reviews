    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3">
                <h1 class="card-title">Edit {{ $name }} AI </h1>
                <div class="relative overflow-x-auto p-5">
                    <form enctype="multipart/form-data" wire:submit.prevent='updateAi'>
                        ...
                        <div class="mt-4">
                            <x-label for="new_logo" value="{{ __('Ai Logo / Image') }}" />
                            <x-input id="new_logo" class="block mt-1 w-full" type="file" name="new_logo" wire:model='new_logo'  />
                            @error('new_logo')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                                    ...
                                    <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                      <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                        ...
                                        <img src="{{ $new_logo->temporaryurl() }}" alt="">
                                          ...
                                          @else
                                          <img src="{{ asset('assets/images/ai') }}/{{ $logo }}" alt="">
                                          @endif
                                      </label>
