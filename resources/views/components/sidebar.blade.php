<aside class="block xl:block sm:hidden sidebar-wrapper w-[300px] fixed top-0  h-full z-30"
  ...
  <div class="sidebar-header relative  w-full h-[108px] flex items-center pl-[50px] z-30">
    <a href="{{ route('admin.dashboard') }}">
      <img src="{{ asset('assets/images/logo.png') }}" style="width: 120px; height:50px;" class="block dark:hidden" alt="logo" />
      <img src="{{ asset('assets/images/logo.png') }}" style="width: 120px; height:50px;" class="hidden dark:block " alt="logo" />
    </a>
            ...
            <a href="#">
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200" style="text-transform:capitalize;">{{ Auth::user()->utype }}</span>
                </div>
                <span>
                  <i class="fa-solid fa-circle-chevron-right text-blue-200"></i>
                </span>
              </div>
            </a>
            <ul class="sub-menu mt-[22px] ml-2.5 pl-5 border-l border-success-100">
              ...
              <li>
                <a href="{{ route('teams.create') }}"
                  class="text-md font-medium text-gray-100  transition-all py-1.5 inline-block hover:text-bgray-800">Create team</a>
              </li>
              {{-- <li>
                <a href="{{ route('teams.show', Auth::user()->currentTeam->id) }}"
                  class="text-md font-medium text-gray-100  transition-all py-1.5 inline-block hover:text-bgray-800">Teams</a>
              </li> --}}
              <li>
            ...
            <a href="{{ route('admin.dashboard') }}"  >
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">Dashboard</span>
                </div>
            ...
            <a href="javascript:void();">
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">Categories</span>
                </div>
                <span>
                  <i class="fa-solid fa-circle-chevron-right text-blue-200"></i>
                </span>
            ...
            <a href="javascript:void();">
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">AI Setting</span>
                </div>
                <span>
                  <i class="fa-solid fa-circle-chevron-right text-blue-200"></i>
                </span>
            ...
            <a href="javascript:void();">
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">AI Prompt</span>
                </div>
                <span>
                  <i class="fa-solid fa-circle-chevron-right text-blue-200"></i>
                </span>
            ...
            <a href="javascript:void();">
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">AI Chaining</span>
                </div>
                <span>
                  <i class="fa-solid fa-circle-chevron-right text-blue-200"></i>
                </span>
            ...
            <a href="javascript:void();">
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">Packages</span>
                </div>
                <span>
                  <i class="fa-solid fa-circle-chevron-right text-blue-200"></i>
                </span>
            ...
            <a href="{{ route('admin.settings') }}"  >
              <div class="flex items-center justify-between">
                <div class="flex space-x-2.5 items-center">
                  ...
                  <span class="item-text text-md font-medium text-blue-200">System Settings</span>
                </div>
